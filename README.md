...
![播放量层级分布](results/figures/cleaned-view_distribution_bins.png)

播放量分布呈现右偏特征：20万-100万区间占比最高（45.62%，n=2,808），5万-20万次之（38.18%，n=2,350），百万级爆款占比16.2%（n=997）。该分布验证了采集规则的有效性。

![视频标签分布](results/figures/cleaned-tag_distribution_top30.png)
...
![标签组合效率](results/step5/figures/step5_A_real_efficiency_bar.png)

> **可视化洞察**：Top 6高效标签组合中，4个含"搞笑"元素，验证"硬核知识泛娱乐化封装"的流量密码效应。

##### 标签组合共现频次可视化

![标签组合共现](results/step5/figures/step5_A_cooc_bar.png)
...
![标题-标签一致性与播放量U型关系](results/step5/figures/step5_B_consistency_scatter.png)
...
![OLS残差图](results/step5/figures/step5_B_residuals.png)
...
![平均情感-弹幕密度曲线](results/step5/figures/step5_D_mean_emotion_curve.png)
...
![DeepSeek-R1发布ITS](results/step5/figures/step5_E_its_DeepSeek-R1发布.png)

![Sora发布ITS](results/step5/figures/step5_E_its_Sora发布.png)

![DeepSeek登顶美区AppStore](results/step5/figures/step5_E_its_DeepSeek登顶美区AppStore.png)

![豆包年末更新ITS](results/step5/figures/step5_E_its_豆包年末更新.png)
...
![DeepSeek-R1发布CAR](results/step5/figures/step5_F_car_DeepSeek-R1发布.png)

![DeepSeek登顶美区CAR](results/step5/figures/step5_F_car_DeepSeek登顶美区AppStore.png)

![Sora发布CAR](results/step5/figures/step5_F_car_Sora发布.png)

![豆包年末更新CAR](results/step5/figures/step5_F_car_豆包年末更新.png)
...
![标题范式效率](results/step5/figures/step5_G_type_efficiency.png)
